...
**Your tier:** Need to confirm (Max 5x or Max 20x?)

**Limits (need to verify your specific tier):**
...
**Reset schedule:**
- 5-hour rolling windows for rate limiting
- Weekly cap resets every 7 days (need to find your specific reset day)
